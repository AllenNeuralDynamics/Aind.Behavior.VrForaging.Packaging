...
- [error-policy.md](error-policy.md) — what `strict_parsing` covers and what it must never swallow; why the pipeline propagates every failure instead of isolating it.
