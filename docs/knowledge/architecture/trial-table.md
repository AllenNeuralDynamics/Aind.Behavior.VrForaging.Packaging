...
| `has_force_rewards` | bool | Whether a forced/manual reward fell in this site's interval. Exact event times and payloads are in the [events table](continuous-and-event-streams.md) (`event_name="ManualWaterDelivery"`), not duplicated here. |
