"""Server layer for running :mod:`aind_behavior_vr_foraging_packaging` at scale.
...
Requires the ``server`` optional dependency group (``pip install
aind-behavior-vr-foraging-packaging[server]``). Nothing in the base
